...
namespace AvantiPoint.Packages.Core
{
    public class RegistrationBuilder
    {
        ...
        public virtual NuGetApiRegistrationIndexResponse BuildIndex(PackageRegistration registration)
        {
            ...
            return new NuGetApiRegistrationIndexResponse
            {
...
#pragma warning restore CS0618
        ...
        private NuGetApiRegistrationIndexPageItem ToRegistrationIndexPageItem(Package package) =>
            new NuGetApiRegistrationIndexPageItem
            {
                ...
                PackageMetadata = new NuGetApiMetadata
                {
