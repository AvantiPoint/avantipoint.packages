        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OciSegment = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlatformOs = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    PlatformArch = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    ArtifactKind = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false, defaultValue: "Unknown"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeedId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    OciSegment = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    RepositoryName = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManifestDigest = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    Origin = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false, defaultValue: "Published")
                },
                constraints: table =>
                {
