        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OciSegment = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OciSegment = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    Digest = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    MediaType = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    PlatformOs = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    PlatformArch = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ArtifactKind = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false, defaultValue: "Unknown"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Key = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UploadId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    FeedId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    OciSegment = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
