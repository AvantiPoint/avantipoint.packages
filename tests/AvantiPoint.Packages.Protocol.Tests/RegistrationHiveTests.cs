...
/// </summary>
public class RegistrationHiveTests(NuGetServerFixture fixture) : IClassFixture<NuGetServerFixture>
{
    [Fact]
    public async Task ServiceIndex_ExposesAllRegistrationHives()
    {
        // Act
        var serviceIndex = await fixture.Server.Client.GetFromJsonAsync<ServiceIndexResponse>("/v3/index.json", TestContext.Current.CancellationToken);
    ...
    public async Task RegistrationsBaseUrl_3_4_0_Endpoint_RespondsCorrectly()
    {
        ...
        var response = await fixture.Server.Client.GetAsync("/v3/registration-gz-semver1/nonexistent.test.package/index.json", TestContext.Current.CancellationToken);
    ...
    public async Task RegistrationsBaseUrl_3_6_0_Endpoint_RespondsCorrectly()
    {
        ...
        var response = await fixture.Server.Client.GetAsync("/v3/registration-gz-semver2/nonexistent.test.package/index.json", TestContext.Current.CancellationToken);
    ...
    public async Task RegistrationsBaseUrl_Leaf_Endpoints_RespondCorrectly()
    {
        ...
        var response1 = await fixture.Server.Client.GetAsync("/v3/registration-gz-semver1/nonexistent.test.package/1.0.0.json", TestContext.Current.CancellationToken);
        ...
        var response2 = await fixture.Server.Client.GetAsync("/v3/registration-gz-semver2/nonexistent.test.package/1.0.0.json", TestContext.Current.CancellationToken);
    ...
    public async Task LegacyRegistrationEndpoint_AcceptsSemVerLevelParameter()
    {
        ...
        var response = await fixture.Server.Client.GetAsync("/v3/registration/nonexistent-package/index.json?semVerLevel=2.0.0", TestContext.Current.CancellationToken);
    ...
    public async Task LegacyRegistrationEndpoint_WithoutSemVerLevel_Works()
    {
        ...
        var response = await fixture.Server.Client.GetAsync("/v3/registration/nonexistent-package/index.json", TestContext.Current.CancellationToken);
        
        // Assert - Should get 404 (not found) not 500 (server error)
        Assert.Equal(System.Net.HttpStatusCode.NotFound, response.StatusCode);
    }

    private static async Task<string> DecompressGzipResponse(HttpResponseMessage response, CancellationToken cancellationToken)
    {
