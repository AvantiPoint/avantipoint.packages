...
public class PackageTypeSearchTests : IDisposable
{
            ...
            .WithWebHostBuilder(builder =>
            {
                builder.ConfigureAppConfiguration((context, config) =>
                {
                    config.AddInMemoryCollection(new Dictionary<string, string?>
                    {
                        ...
                        { "Storage:Path", Path.Combine(Path.GetTempPath(), $"PackageTypeSearchTests-{Guid.NewGuid()}") }
                    });
                });
    ...
    private static void SeedTestPackages(IContext context)
    {
    ...
    {
        // Act
        var response = await _client.GetAsync("/v3/search?q=&take=100", TestContext.Current.CancellationToken);
        
        // Assert
        response.EnsureSuccessStatusCode();
        var searchResponse = await response.Content.ReadFromJsonAsync<SearchResponse>(TestContext.Current.CancellationToken);
    ...
    {
        // Act
        var response = await _client.GetAsync("/v3/search?packageType=DotnetTool&take=100", TestContext.Current.CancellationToken);
    ...
    {
        // Act
        var response = await _client.GetAsync("/v3/search?packageType=Template&take=100", TestContext.Current.CancellationToken);
    ...
    {
        // Act
        var response = await _client.GetAsync("/v3/search?packageType=Template&prerelease=true&take=100", TestContext.Current.CancellationToken);
    ...
    {
        // Act
        var response = await _client.GetAsync("/v3/search?packageType=NonExistentType&take=100", TestContext.Current.CancellationToken);
    ...
    {
        // Act
        var response = await _client.GetAsync("/v3/search?packageType=Dependency&take=100", TestContext.Current.CancellationToken);
    ...
    {
        // Act
        var response = await _client.GetAsync("/v3/search?packageType=CustomType&take=100", TestContext.Current.CancellationToken);
    ...
    {
        // Act
        var response = await _client.GetAsync("/v3/autocomplete?q=My&take=100", TestContext.Current.CancellationToken);
        
        // Assert
        response.EnsureSuccessStatusCode();
        var autocompleteResponse = await response.Content.ReadFromJsonAsync<AutocompleteResponse>(TestContext.Current.CancellationToken);
    ...
    {
        // Act
        var response = await _client.GetAsync("/v3/autocomplete?packageType=DotnetTool&take=100", TestContext.Current.CancellationToken);
    ...
    {
        // Act
        var response = await _client.GetAsync("/v3/autocomplete?packageType=Template&take=100", TestContext.Current.CancellationToken);
    ...
    {
        // Act
        var response = await _client.GetAsync("/v3/autocomplete?packageType=Template&prerelease=true&take=100", TestContext.Current.CancellationToken);
    ...
    {
        // Act
        var response = await _client.GetAsync("/v3/autocomplete?packageType=NonExistentType&take=100", TestContext.Current.CancellationToken);
    ...
    {
        // Act
        var response = await _client.GetAsync("/v3/search?q=MyDotnetTool", TestContext.Current.CancellationToken);
