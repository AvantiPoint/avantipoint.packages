...
You must configure one database provider. See [Database Configuration](database/index.md) for details.
...
You must configure one storage provider. See [Storage Configuration](storage/index.md) for details.
