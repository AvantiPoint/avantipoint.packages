...
- [Sample: AuthenticatedFeed](https://github.com/AvantiPoint/avantipoint.packages/tree/master/samples/AuthenticatedFeed) - Complete working example with callbacks
